...
void UUNUNNetworking::Initialize(FSubsystemCollectionBase& Collection)
{
...
void UUNUNNetworking::Deinitialize()
{
...
void UUNUNNetworking::StartClient()
{
    // Create UDP socket
...
void UUNUNNetworking::DiscoverServer()
{
    if (!UdpSocket) return;
...
void UUNUNNetworking::StopClient()
{
...
void UUNUNNetworking::SendRawString(const FString& Message)
{
    if (!UdpSocket)
        return;
...
void UUNUNNetworking::StartEvent()
{
    SendRawString(TEXT("START_EVENT"));
}

void UUNUNNetworking::HandlePacket(const FArrayReaderPtr& Data, const FIPv4Endpoint& Endpoint)
{
